...
//        self.edgesForExtendedLayout=UIRectEdgeNone;
    ...
    CustomOverlay* custom = [[[CustomOverlay alloc] initWithPoints:temppoints count:2] autorelease];
    ...
    CustomOverlay* custom2 = [[[CustomOverlay alloc] initWithPoints:temppoints2 count:3] autorelease];
