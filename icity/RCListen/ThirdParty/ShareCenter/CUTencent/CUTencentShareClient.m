...
- (void)CUSendWithText:(NSString *)text andImage:(UIImage *)image delegate:(id)delegate
{
    ...
    [request setCompleteBlock: ^(NSString * responseString){
        ...
        if(super.myDelegate && [super.myDelegate respondsToSelector:@selector(sendTextSucceeded:)])
        {
            [super.myDelegate sendTextSucceeded:nil];
        }
    }];
    ...
    [request setFailureBlock: ^(NSError * error){
        ...
        if(super.myDelegate && [super.myDelegate respondsToSelector:@selector(sendTextFailed:)])
        {
            [super.myDelegate sendTextFailed:nil];
        }
    }];
