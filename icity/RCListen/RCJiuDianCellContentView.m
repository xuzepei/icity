...
#import "RCJiuDianCellContentView.h"
...
@implementation RCJiuDianCellContentView
...
- (void)drawRect:(CGRect)rect
{
        ...
        
    {
        ...
        CGSize size = [pingfen drawInRect:CGRectMake(offset_x, offset_y, 100, 20) withFont:[UIFont systemFontOfSize:16] lineBreakMode:NSLineBreakByTruncatingTail
               alignment:NSTextAlignmentLeft];
        
        offset_x += size.width;
        [[UIColor blackColor] set];
        [@"/5.0分" drawInRect:CGRectMake(offset_x,offset_y, 100, 20) withFont:[UIFont systemFontOfSize:16] lineBreakMode:NSLineBreakByTruncatingTail
                  alignment:NSTextAlignmentLeft];
    }
    ...
    [[UIColor blackColor] set];
    CGSize size = [@"参考价: " drawInRect:CGRectMake(offset_x,offset_y, 100, 20) withFont:[UIFont systemFontOfSize:16] lineBreakMode:NSLineBreakByTruncatingTail
               alignment:NSTextAlignmentLeft];
