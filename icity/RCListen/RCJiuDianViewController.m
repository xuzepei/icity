...
- (void)updateContent:(NSDictionary*)item
{
    ...
    NSString* urlString = [NSString stringWithFormat:@"%@/index.php?c=main&a=bdsearch&type=1&jd_id=%@&tag=%@&pageno=%d&radius=%@&token=%@",BASE_URL,jd_id,tag,self.pageno,radius,[RCTool getDeviceID]];
...
- (void)initHeaderView
{
    ...
    [array addObject:@"全部"];
    [array addObject:@"快捷酒店"];
    [array addObject:@"五星级"];
    [array addObject:@"四星级"];
    [array addObject:@"三星级"];
    [array addObject:@"公寓式酒店"];
    [array addObject:@"青年旅舍"];
    [array addObject:@"招待所"];
    [array addObject:@"度假村"];
    [dict setObject:array forKey:@"values"];
