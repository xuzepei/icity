...
+ (NSString*)saveSendImageToLocal:(UIImage *)image
{
    ...
    long long interval = (long long)[date timeIntervalSince1970];
    
	NSString* savePath = [NSString stringWithFormat:@"%@/sendImage_%lld.jpg",[RCTool getUserDocumentDirectoryPath],interval];
